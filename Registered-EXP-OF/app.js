    ...
    if(getData.length > 0){
        for(var i=tab_start; i<tab_end; i++){
            ...
            if(staff){
                ...
                <td>${staff.cityVal}</td>
                <td>
                    <button onclick="readInfo('${staff.picture}', '${staff.fName}', '${staff.ageVal}', '${staff.cityVal}')"><i class="fa-regular fa-eye"></i></button>

                    <button onclick="editInfo('${i}', '${staff.picture}', '${staff.fName}', '${staff.ageVal}', '${staff.cityVal}')"><i class="fa-regular fa-pen-to-square"></i></button>
...
function readInfo(pic, fname, Age, City){
    imgInput.src = pic
    fName.value = fname
    age.value = Age
    city.value = City
...
function editInfo(id, pic, fname, Age, City){
    isEdit = true
    editId = id
...
filterData.addEventListener("input", ()=> {
    ...
    if(searchTerm !== ""){
        ...
        const filteredData = originalData.filter((item) => {
            ...
            const age = item.ageVal.toLowerCase()
